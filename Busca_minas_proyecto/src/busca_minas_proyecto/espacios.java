...
public class espacios {
     ...
     **/ //Metodo para retornar si es mina me devuelve el valor para evaluar el valor valga la redundancia.
    public boolean verMina(){
    return esMina;
    }  
    /**
     ** Me dice lo siguiente "ya pasaste por este espacio mientras estas jugando" sirve para saber si uno gana.
     **@return
     */
    ...
    /**
     *En el momento que visite el espacio este cambia su estado a revelado.
     */
